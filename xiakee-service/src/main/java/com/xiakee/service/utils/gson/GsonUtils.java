...
public class GsonUtils {
    ...
    public static String toJson(Object target) {
        return toJson(target, false, DEFAULT_DATE_PATTERN, null);
    }

    public static String toJson(Object target, List<String> skipFields) {
        return toJson(target, false, DEFAULT_DATE_PATTERN, skipFields);
    }

    public static String toJson(Object target, boolean isSerializeNulls, String datePattern, List<String> skipFields) {
        if (target == null)
            return EMPTY_JSON;
        GsonBuilder builder = new GsonBuilder();
        if (isSerializeNulls)
            builder.serializeNulls();
        builder.setDateFormat(datePattern);
        builder.setExclusionStrategies(new SkipFieldStrategy(skipFields));
    ...
    /*public static void main(String[] args) {
        ...
        map.put("null", null);
        map.put("Long", 1234L);
        map.put("List", Arrays.asList("1234", "567"));
        String x = toJson(map, false, DEFAULT_DATE_PATTERN, null);
        System.out.println(x);

        Map x2 = fromJson(x, Map.class);
        System.out.println(x2);

        User user = new User();
        user.setUserId("1234");
//        user.setUserNickName("康维");
        System.out.println(toJson(user, null, true, SINCE_VERSION_10, DEFAULT_DATE_PATTERN, false));

        String x1 = toJson(user, false, DEFAULT_DATE_PATTERN, null);
        System.out.println(x1);
        System.out.println(fromJson(x1, User.class));
    }*/
}
